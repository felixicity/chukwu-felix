---
title: "What is MCP and why should I be concerned as a developer."
date: "2026-06-23"
author: "Chukwu Felix"
tags: [AI-Engineering]
description: "The Model Context Protocol (MCP) is an open-source standard that allows AI applications to connect to external systems. This article explains what MCP is, how it works, and why developers should care about it."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Build MCP Apps" icon="puzzle-icon" href="/extensions/apps/overview">
